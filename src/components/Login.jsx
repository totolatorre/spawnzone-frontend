  ...
  return (
    <div className='h-[calc(100vh-120px)] flex justify-center items-center '>
        <div className='w-full max-w-sm mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4'>
            ...
            <p className='align-baseline font-medium mt-4 text-sm'>Non sei registrato? <Link to="/registrati" className='text-blue-500 hover:text-blue-700'>Registrati</Link></p>
