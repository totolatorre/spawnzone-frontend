    ...
    <>
     <section className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold">{data?.totalVideogames}</span>
                  <span className="block text-gray-500">Prodotti</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="block text-2xl font-bold">${data?.totalSales.toFixed(1)}</span>
                  <span className="block text-gray-500">Vendita totali</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  <span className="inline-block text-2xl font-bold">{data?.trendingVideogames}</span>
                  <span className="inline-block text-xl text-gray-500 font-semibold">(13%)</span>
                  <span className="block text-gray-500">Videogiochi di tendenza questo mese</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Ordini totali</span>
                </div>
              </div>
            </section>
            <section className="grid md:grid-cols-2 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col gap-6">
              <div className="flex flex-col md:col-span-2 md:row-span-2 bg-white shadow rounded-lg">
                <div className="px-6 py-5 font-semibold border-b border-gray-100">Ordini per mese</div>
              ...
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Ordini rimasti</span>
                </div>
              </div>
              <div className="flex items-center p-8 bg-white shadow rounded-lg">
                ...
                <div>
                  ...
                  <span className="block text-gray-500">Visite (ultimo giorno)</span>
                </div>
              </div>
              <div className="row-span-3 bg-white shadow rounded-lg">
                <div className="flex items-center justify-between px-6 py-5 font-semibold border-b border-gray-100">
                  <span>Utenti per ordine medio</span>
                ...
                <div className="overflow-y-auto" style={{maxHeight: '24rem'}}>
                  <ul className="p-6 space-y-6">
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Mario Rossi</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Luca Greco</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Antonio Barbero</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Marc Renè</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Jack O'Nel</span>
                      <span className="ml-auto font-semibold">8.2</span>
                    </li>
                    <li className="flex items-center">
                      <div className="h-10 w-10 mr-3 bg-gray-100 rounded-full overflow-hidden">
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Gerardo Meliota</span>
                    ...
                    <li className="flex items-center">
                      ...
                      <span className="text-gray-600">Gianvito Meliota</span>
