        ...
        <section>
            <div className="min-h-screen p-6 bg-gray-100 flex items-center justify-center">
                <div className="container max-w-screen-lg mx-auto">
                    <div>
                        <div>
                            <h2 className="font-semibold text-xl text-gray-600 mb-2">Paga alla consegna</h2>
                            <p className="text-gray-500 mb-2">Prezzo totale: £{totalPrice}</p>
                            <p className="text-gray-500 mb-6">Oggetti: {cartItems.length > 0 ? cartItems.length : 0}</p>
                        </div>
                            ...
                            <div className="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                                <form onSubmit={handleSubmit(onSubmit)} className="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3 my-8">
                                    <div className="text-gray-600">
                                        <p className="font-medium text-lg">Dettagli personali:</p>
                                        <p>Per favore completa i campi.</p>
                                    </div>
                                        ...
                                        <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                            ...
                                            <div className="md:col-span-5 mt-3">
                                                <div className="inline-flex items-center">
                                                    ...
                                                    <label htmlFor="billing_same" className="ml-2 ">Sono d'accordo con i <Link className='underline underline-offset-2 text-blue-600'>Termini e Condizioni</Link> e <Link className='underline underline-offset-2 text-blue-600'>la politica di spedizione.</Link></label>
                                                </div>
                                            </div>
                                            ...
                                            <div className="md:col-span-5 text-right">
                                                <div className="inline-flex items-end">
                                                    <button
                                                        disabled={!isChecked}
                                                        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Inserisci un ordine</button>
                                                </div>
                                            </div>
